...
describe('StateController', () => {
  ...
  describe('createPaths', () => {
    it('should create data and log directories', () => {
      ...
      expect(fs.mkdirSync).toHaveBeenCalledWith('/fake/data', {
        recursive: true,
      });
      expect(fs.mkdirSync).toHaveBeenCalledWith('/fake/log', {
        recursive: true,
      });
    });
  });
        ...
        nodes: [
          {
            ...
            port: 18444,
            rpcPort: 18443,
            dataDir: '/fake/data/nodes/test-node',
          },
        ],
        exist: true,
      };
